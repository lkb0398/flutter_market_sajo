...
#ifndef FLUTTER_MARKET_SAJO_SWIFT_H
#define FLUTTER_MARKET_SAJO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="flutter_market_sajo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC19flutter_market_sajo11AppDelegate")
...
SWIFT_CLASS("_TtC19flutter_market_sajo17MainFlutterWindow")
